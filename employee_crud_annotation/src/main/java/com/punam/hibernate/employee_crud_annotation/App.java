...
public class App {
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new Employee(3, "punam", "IT", "Dev", 12345);
        ...
        Employee e2 = s2.get(Employee.class, 3);
        ...
        Employee e3 = s3.get(Employee.class, 3);
        ...
        Employee e4 = s4.get(Employee.class, 3);
